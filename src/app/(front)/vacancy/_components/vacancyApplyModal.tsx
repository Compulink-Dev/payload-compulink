...
export function VacancyApplyModal() {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      console.log('Failed to sumbit application : ', error)
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Fill in your details and upload your CV</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            {errors.cv && (
              <p className="text-red-500 text-sm mt-1">{errors.cv.message as string}</p>
            )}
          </div>
