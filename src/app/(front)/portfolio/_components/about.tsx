...
function AboutSection() {
  return (
    <>
      <div className="bg-fixed bg-[url('/AI.jpg')] h-screen bg-cover w-full object-">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-x-4 py-10 ">
            ...
            <div className="col-span-2">
              <p className="flex items-center justify-center pt-2 px-6 text-center text-white ">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit dolorem, incidunt
                voluptatem, magnam ducimus officia aliquid illum sint unde laborum nemo mollitia
                quis error recusandae dolor. Ullam non illum fugiat?
              </p>
            </div>
          </div>
